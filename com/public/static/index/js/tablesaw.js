...
;(function ($) {
    var pluginName = "table", classes = {
        ...
        create: "tablesawcreate", destroy: "tablesawdestroy", refresh: "tablesawrefresh"
...
;(function (win, $, undefined) {
    var classes = {
        stackTable: 'tablesaw-stack', cellLabels: 'tablesaw-cell-label', cellContentLabels: 'tablesaw-cell-content'
    };
    ...
    var attrs = {
        labelless: 'data-tablesaw-no-labels', hideempty: 'data-tablesaw-hide-empty'
    };
...
;(function (win, $, undefined) {
    $.extend(Tablesaw.config, {
        swipe: {
            horizontalThreshold: 15, verticalThreshold: 30
        }
    });
...
;(function ($) {
    ...
    var pluginName = "tablesaw-sortable", initSelector = "table[data-" + pluginName + "]",
        sortableSwitchSelector = "[data-" + pluginName + "-switch]", attrs = {
            defaultCol: "data-tablesaw-sortable-default-col", numericCol: "data-tablesaw-sortable-numeric"
        }, classes = {
            ...
            _init: function () {
                ...
                var getCells = function (rows) {
                    ...
                    $.each(rows, function (i, r) {
                        ...
                        cells.push({
                            element: element, cell: getSortValue(element), rowNum: i
                        });
                    });
                    return cells;
...
;(function (win, $) {
    var S = {
        selectors: {
            ...
            main: 'tablesaw-modeswitch', toolbar: 'tablesaw-toolbar'
        }, modes: ['stack', 'swipe', 'columntoggle'], init: function (table) {
